<x-layouts.app title="Chart Radar Grid Circle No Lines">
    <div class="flex min-h-svh items-center justify-center p-6">
        <div class="w-full max-w-md">
            <x-ui.card variant="sectioned">
                <x-ui.card-header class="items-center pb-4">
                    <x-ui.card-title>Radar Chart - Grid Circle - No lines</x-ui.card-title>
                ...
                <x-ui.card-content class="pb-0">
                    <x-ui.chart
                        ...
                        :series="[['name' => 'Desktop', 'data' => [186, 305, 237, 203, 209, 214]]]"
                        :colors="['var(--chart-1)']"
                        :options="[
