<x-layouts.app title="Chart Radar Grid None">
    <div class="flex min-h-svh items-center justify-center p-6">
        <div class="w-full max-w-md">
            <x-ui.card variant="sectioned">
                <x-ui.card-header class="items-center pb-4">
                    <x-ui.card-title>Radar Chart - Grid None</x-ui.card-title>
                ...
                <x-ui.card-content class="pb-0">
                    <x-ui.chart
                        ...
                        :options="[
                            ...
                            'markers' => ['size' => 4],
                            'grid' => ['show' => false],
                            'plotOptions' => ['radar' => ['polygons' => ['strokeColors' => 'transparent', 'connectorColors' => 'transparent']]],
                        ]"
