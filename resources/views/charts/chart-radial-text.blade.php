                ...
                <x-ui.card-content class="flex-1 pb-0">
                    <div class="relative mx-auto aspect-square max-h-[250px]">
                        <x-ui.chart
                            ...
                            :colors="['var(--chart-2)']"
                            :options="[
                                'plotOptions' => ['radialBar' => ['hollow' => ['size' => '70%'], 'track' => ['show' => true], 'dataLabels' => ['show' => false]]],
                        ...
                        <div class="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
                            <span class="text-foreground text-4xl font-bold">200</span>
