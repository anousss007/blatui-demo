<x-layouts.app title="Chart Radar Lines Only">
    <div class="flex min-h-svh items-center justify-center p-6">
        <div class="w-full max-w-md">
            <x-ui.card variant="sectioned">
                <x-ui.card-header class="items-center pb-4">
                    <x-ui.card-title>Radar Chart - Lines Only</x-ui.card-title>
                ...
                <x-ui.card-content class="pb-0">
                    <x-ui.chart
                        ...
                        :series="[['name' => 'Desktop', 'data' => [186, 185, 207, 173, 160, 174]], ['name' => 'Mobile', 'data' => [160, 170, 180, 160, 190, 204]]]"
                        ...
                        :options="[
                            ...
                            'stroke' => ['width' => 2],
                            'markers' => ['size' => 0],
                            'plotOptions' => ['radar' => ['polygons' => ['strokeColors' => 'var(--border)', 'connectorColors' => 'transparent']]],
                        ]"
