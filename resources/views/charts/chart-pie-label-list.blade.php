        ...
        <div class="w-full max-w-md">
            <x-ui.card variant="sectioned" class="flex flex-col">
                ...
                <x-ui.card-content class="flex-1 pb-0">
                    {{-- Recharts prints the browser name on each slice. ApexCharts dataLabels render the percentage instead; the browser names are surfaced via the tooltip/labels. --}}
                    <x-ui.chart
                        type="pie"
