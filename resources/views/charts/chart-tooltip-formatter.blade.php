<x-layouts.app title="Chart Tooltip Formatter">
    <div class="flex min-h-svh items-center justify-center p-6">
        <div class="w-full max-w-md">
            <x-ui.card variant="sectioned">
                <x-ui.card-header>
                    <x-ui.card-title>Tooltip - Formatter</x-ui.card-title>
                    <x-ui.card-description>Tooltip with custom formatter .</x-ui.card-description>
                </x-ui.card-header>
                <x-ui.card-content>
                    <x-ui.chart
                        type="bar"
