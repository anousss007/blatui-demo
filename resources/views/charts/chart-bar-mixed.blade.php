<x-layouts.app title="Chart Bar Mixed">
    <div class="flex min-h-svh items-center justify-center p-6">
        <div class="w-full max-w-md">
            <x-ui.card variant="sectioned">
                <x-ui.card-header>
                    <x-ui.card-title>Bar Chart - Mixed</x-ui.card-title>
                ...
                <x-ui.card-content>
                    <x-ui.chart
                        ...
                        :options="[
                            'xaxis' => ['categories' => ['Chrome', 'Safari', 'Firefox', 'Edge', 'Other'], 'labels' => ['show' => false], 'axisBorder' => ['show' => false], 'axisTicks' => ['show' => false]],
