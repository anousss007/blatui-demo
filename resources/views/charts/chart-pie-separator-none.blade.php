            ...
            <x-ui.card variant="sectioned" class="flex flex-col">
                ...
                <x-ui.card-content class="flex-1 pb-0">
                    <x-ui.chart
                        ...
                        :options="['legend' => ['show' => false], 'stroke' => ['width' => 0], 'tooltip' => ['enabled' => true], 'dataLabels' => ['enabled' => false]]"
