            ...
            <x-ui.card variant="sectioned" class="flex flex-col">
                ...
                <x-ui.card-content class="flex-1 pb-0">
                    <x-ui.chart
                        ...
                        :options="[
                            'plotOptions' => ['radialBar' => ['hollow' => ['size' => '30%'], 'track' => ['show' => true], 'dataLabels' => ['show' => false]]],
                            'legend' => ['show' => false],
