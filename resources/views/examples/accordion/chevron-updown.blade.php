{{-- Chevron that swaps down → up instead of rotating. --}}
<x-ui.accordion type="single" collapsible value="item-1" class="w-full max-w-md">
    <x-ui.accordion-item value="item-1">
        <x-ui.accordion-trigger icon="chevron-updown">How do I track my order?</x-ui.accordion-trigger>
    ...
    <x-ui.accordion-item value="item-2">
        <x-ui.accordion-trigger icon="chevron-updown">What is your return policy?</x-ui.accordion-trigger>
    ...
    <x-ui.accordion-item value="item-3">
        <x-ui.accordion-trigger icon="chevron-updown">Do you ship internationally?</x-ui.accordion-trigger>
