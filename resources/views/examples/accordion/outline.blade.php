{{-- Each item is fully outlined and separated. --}}
<x-ui.accordion type="single" collapsible value="item-1" class="w-full max-w-md space-y-2">
    <x-ui.accordion-item value="item-1" class="rounded-lg border last:border-b">
        <x-ui.accordion-trigger class="px-5">How do I track my order?</x-ui.accordion-trigger>
    ...
    <x-ui.accordion-item value="item-2" class="rounded-lg border last:border-b">
        <x-ui.accordion-trigger class="px-5">What is your return policy?</x-ui.accordion-trigger>
    ...
    <x-ui.accordion-item value="item-3" class="rounded-lg border last:border-b">
        <x-ui.accordion-trigger class="px-5">Do you ship internationally?</x-ui.accordion-trigger>
