...
<div class="flex w-full max-w-xl flex-col gap-3">
    <x-ui.alert class="border-info text-info bg-card [&>svg]:text-info">
        ...
        <x-ui.alert-description class="text-info/80">Version 2.4 is ready to install.</x-ui.alert-description>
    </x-ui.alert>
    <x-ui.alert class="border-success text-success bg-card [&>svg]:text-success">
        ...
        <x-ui.alert-description class="text-success/80">Your profile has been updated.</x-ui.alert-description>
    </x-ui.alert>
    <x-ui.alert class="border-warning text-warning bg-card [&>svg]:text-warning">
        ...
        <x-ui.alert-description class="text-warning/80">You've used 90% of your quota.</x-ui.alert-description>
    </x-ui.alert>
    <x-ui.alert class="border-destructive text-destructive bg-card [&>svg]:text-destructive">
        ...
        <x-ui.alert-description class="text-destructive/80">Please try again in a few minutes.</x-ui.alert-description>
    </x-ui.alert>
</div>
