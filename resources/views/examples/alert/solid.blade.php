...
<div class="flex w-full max-w-xl flex-col gap-3">
    <x-ui.alert class="bg-primary text-primary-foreground border-none [&>svg]:text-primary-foreground">
        ...
        <x-ui.alert-description class="text-primary-foreground/80">Changes won't be saved until you click "Update".</x-ui.alert-description>
    </x-ui.alert>
    <x-ui.alert class="bg-success text-success-foreground border-none [&>svg]:text-success-foreground">
        ...
        <x-ui.alert-description class="text-success-foreground/80">Your subscription is now active.</x-ui.alert-description>
    </x-ui.alert>
    <x-ui.alert class="bg-warning text-warning-foreground border-none [&>svg]:text-warning-foreground">
        ...
        <x-ui.alert-description class="text-warning-foreground/80">Confirm your email address to continue.</x-ui.alert-description>
    </x-ui.alert>
    <x-ui.alert class="bg-destructive border-none text-white [&>svg]:text-white">
        ...
        <x-ui.alert-description class="text-white/80">Please sign in again to continue.</x-ui.alert-description>
    </x-ui.alert>
</div>
