...
return [
    ...
    'description' => env('BRAND_DESCRIPTION', 'Open-source shadcn/ui for the BLAT stack — Blade, Laravel, Alpine.js & Tailwind CSS v4. 81 components (416 variants), 64 blocks, 70 charts and 34 page templates you copy, paste and own. MIT licensed.'),
